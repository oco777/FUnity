...
- [FUnityProjectData の生成](#funityprojectdata-の生成)
- [補足情報](#補足情報)
...
## 補足情報
- **FUnity/Create/FUnityProjectData** 実行時に `Assets/Resources/FUnityActorData_Fooni.asset` が存在すると、重複防止のために削除されます。
...
- 追加の俳優テンプレートが必要な場合は **FUnity/Create/FUnityActorData** を実行し、生成された ActorData に Macro や Portrait を割り当ててください。
