...
namespace FUnity.Runtime.Integrations.VisualScripting.Units.ScratchUnits
{
    ...
    public sealed class SetCostumeNumberUnit : Unit
    {
        ...
        /// <summary>対象俳優の GameObject を受け取る ValueInput です。</summary>
        [DoNotSerialize]
        ...
        /// <summary>
        /// ポート定義を行い、俳優参照とコスチューム番号の入力を登録します。
        /// </summary>
        protected override void Definition()
        {
            ...
            m_Actor = ValueInput<GameObject>("actor");
        ...
        {
            if (ScratchUnitUtil.TryGetActorAdapter(flow, m_Actor, out var adapter))
            {
    ...
    public sealed class NextCostumeUnit : Unit
    {
        ...
        /// <summary>actor ポートへの参照です。</summary>
        public ValueInput Actor => m_Actor;

        /// <summary>
        /// ポート定義を行い、俳優入力のみを登録します。
        /// </summary>
        protected override void Definition()
        {
            m_Input = ControlInput("in", OnEnter);
